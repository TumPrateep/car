...
class Spareundercarriageproduct extends CI_Model{
    ...
    function allSpareData_count(){
        ...
        $this->db->group_by("spares_undercarriagedata.spares_undercarriageId, spares_undercarriagedata.spares_brandId, spares_undercarriagedata.modelId, spares_undercarriagedata.brandId, spares_undercarriagedata.modelofcarId");
    ...
    function SpareDatas_search_count($spares_undercarriageId, $spares_brandId, $price,$modelId,$brandId,$modelofcarId,$can_change, $modelName=null){
        ...
        $query = $this->db->group_by("spares_undercarriagedata.spares_undercarriageId, spares_undercarriagedata.spares_brandId, spares_undercarriagedata.modelId, spares_undercarriagedata.brandId, spares_undercarriagedata.modelofcarId")
                ->get();
        return $query->num_rows();   
    }
