...
class Menu extends CI_Controller {
    ...
    public function Cart(){
		...
		if(isset($this->session->userdata['logged_in'])){
			$isUser = $this->session->userdata['logged_in']['isUser'];
			if(!$isUser){
				load_user_view("users/cart/notlogin/content", "users/cart/notlogin/script", $data, false);
			}else{
				load_user_view("users/cart/login/content", "users/cart/login/script", $data, false);
			}
		}else{
			load_user_view("users/cart/notlogin/content", "users/cart/notlogin/script", $data, false);
		}
