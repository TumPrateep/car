                ...
                <div class="card col-lg-12">
                    <form id="submit">
                        ...
                        <div class="form-group row ">
                            <!-- <div class="form-group col-md-4">
                                <div class="form-group">
                                    <label class="form-label required" for="garage">รายละเอียดรุ่น</label> <span class="error">*</span>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" name="mileage" id="mileage" placeholder="เลขไมค์"  min=0>
                            </div>
                        </div>
