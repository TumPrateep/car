...
$(document).ready(function () {
        ...
        var html = '<li class="cart_item clearfix">'
            ...
            +'<div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">'
                +'<div class="cart_item_name cart_info_col">'
                    ...
                    +'<div class="cart_item_text">'+product.brandName+' '+product.name+' '+product.lubricatorNumber+' ขนาด '+product.capacity+' ลิตร</div>'
                +'</div>'
    ...
    function getTire(value){
        var product = cartDataDetail["tire"][value.productId];
        var html = '<li class="cart_item clearfix">'
            +'<div class="cart_item_image"><img src="'+base_url+'public/image/tirebranddata/'+product.picture+'" alt=""></div>'
            +'<div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">'
                +'<div class="cart_item_name cart_info_col">'
                    +'<div class="cart_item_title">Name</div>'
                    +'<div class="cart_item_text">'+product.brandName+' '+product.name+' '+product.number+'</div>'
                +'</div>'
    ...
    function getspare(value){
        var product = cartDataDetail["spare"][value.productId];
        var html = '<li class="cart_item clearfix">'
            +'<div class="cart_item_image"><img src="'+base_url+'public/image/spareundercarriage/'+product.picture+'" alt=""></div>'
            +'<div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">'
                +'<div class="cart_item_name cart_info_col">'
                    +'<div class="cart_item_title">Name</div>'
                    
                    +'<div class="cart_item_text">'+product.spares_brandName+' '+product.spares_undercarriageName+' '+product.brandName+' '+product.modelName+' '+product.year+'</div>'
