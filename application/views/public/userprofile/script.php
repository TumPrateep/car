    ...
    $(document).ready(function () {
        ...
        $.post(base_url+"service/Userprofile/getuser",{
            ...
            if(data.message == 200){
                ...
                $("#village").html("  หมู่ที่ "+changeUndefind(result.village));
                $("#road").html("  ถนน "+changeUndefind(result.road));
                $("#alley").html("  ซอย "+changeUndefind(result.alley));
                ...
                $("#phone1").html(changeUndefind(result.phone1));
                $("#phone2").html(changeUndefind(result.phone2));
                $("#postCodes").html("  รหัสไปรษณีย์ "+changeUndefind(result.postCodes));
