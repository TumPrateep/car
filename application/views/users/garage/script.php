                                ...
                                html += '<div class="col-md-6">'
                                        +'<div class="card flex-row flex-wrap">'
                                            +'<div class="card-header col-md-5 text-center">'
                                                +'<img src="'+imagePath+value.picture+'"><br><br>'
                                                +'<h5>ระยะทาง</h5>'
                                                +'<h3>'+distance(value.latitude, value.longitude, latitude, longitude, "กม.")+'</h3>'
                                            +'</div>'
                                            +'<div class="card-block col-md-7">'
                                                ...
                                                +'<p class="card-text">'
                                                    ...
                                                    +'<br>'
                                                    +'<b><i class="fa fa-clock-o" aria-hidden="true"></i></b> '+settimegarage(value.openingtime)+" - "+settimegarage(value.closingtime)+" น."
                                                    +'<br>'
                                                    +'<b><i class="fa fa-phone" aria-hidden="true"></i></b> '+value.phone
                                                    +'<br>'
