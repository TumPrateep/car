            ...
            "columnDefs": [
                ...
                // },
                {
                    ...
                    "render": function ( data, type, full, meta ) {
                        ...
                        var success_status = "";
                        if(data.status == "1"){
                            success_status += '<a href="'+base_url+"shop/payment/"+data.orderId+'"><button type="button" class="btn btn-main-md bg-orange">จ่ายเงิน</button>'
                        }
                        else if(data.status == "3"){
                            success_status +='<a href="#"><button type="button" class="btn btn-main-md bg-orange">รับบริการ</button> '
                        }
                        
                        else if(data.statusSuccess == "2"){
                            success_status +='<a href="#"><button type="button" title="กดเพื่อให้คะเเนนการให้บริการ" onclick="commetrating('+data.orderId+')" class="btn btn-warning"><i class="far fa-thumbs-up"></i></button> '
                        }
                        else if(data.statusSuccess == "3"){
                            success_status +='';
                        }
                        ...
                        html =  '<div class="row border-bottom  pb-2 pt-2">'
                                ...
                                + '</div>'
                                + '<div class="col-md-2 text-center detail">'
                                    + currency(data.cost , {  precision: 0 }).format() + " บาท"
                                + '</div>'
                                + '<div class="col-md-2 text-center detail">'
                                    + orderstatus
                                + '</div>'
                                + '<div class="col-md-2 text-center detail">'
                                    + '<a href="'+base_url+"user/order/orderdetails/"+data.orderId+'" class="btn btn-transparent-md"><i class="fa fa-search"></i></a>'
                                + '</div>'
                                + '<div class="col-md-2 text-center detail">'
                                    + success_status
