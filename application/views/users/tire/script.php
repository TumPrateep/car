                    ...
                    "columnDefs": [
                        {
                            ...
                            "render": function ( data, type, full, meta ) { 
                                ...
                                var html = '<div class="row row-border">'
                                    ...
                                    + '</div>'
                                    + '<div class="brand col-md-3 text-center brand-logo">'
                                        + '<img src="'+base_url+'public/image/tire_brand/'+data.tire_brandPicture+'" width="100%">'
                                    + '</div>'
                                    + '<div class="detail col-md-3">'
                                        + '<a href="'+base_url+'search/tire/resultgarage/'+data.tire_modelId+'/'+data.tire_sizeId+'/'+data.tire_dataId+'">'
                                        + '<div class="card pointer full-view">'
                                        + '<div class="card-body order">'
                                        + 'ราคาต่ำสุด'
                                        + '<h5>'+currency(data.price, {  precision: 0 }).format()+' บาท/เส้น</h5>'
                                        + '</div>'
