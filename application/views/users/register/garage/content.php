<div class="container">
    ...
    <form id="rigister" class="signup-form">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label class="form-label required" for="user_profile">เบอร์โทรศัพท์ที่สามารถติดต่อได้</label><span
                        class="error">*</span>
                    <input type="number" class="form-control main-md btn-ga" name="phone1" id="phone1" minlength="9"
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control main-md btn-ga" name="phone2" id="phone2" minlength="9"
                        placeholder="เบอร์โทรศัพท์">
                </div>
            </div>
        </div>
            ...
            <div class="row p-t-20">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control main-md btn-ga" name="garagename" id="garagename"
                            placeholder="ชื่ออู่ซ่อมรถ">
                    </div>
                    <div class="form-group">
                        <label class="form-label required">หมายเลขทะเบียนการค้า</label><span class="error">*</span>
                        <input type="text" class="form-control main-md btn-ga" name="businessRegistration"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control main-md btn-ga" name="phone_garage" id="phone_garage"
                            minlength="9" placeholder="เบอร์โทรศัพท์">
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="form-check">
                        <label class="form-check-label" for="garage">
                            <input class="form-check-input" name="check[]" id="change_spare" type="checkbox"
                                value="11">เปลี่ยนอะไหล่</label>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-check">
                        <label class="form-check-label" for="garage">
                            <input class="form-check-input" name="check[]" id="change_tire" type="checkbox"
                                value="12">เปลี่ยนยางรถ</label>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-check">
                        <label class="form-check-label" for="garage">
                            <input class="form-check-input" name="check[]" id="change_lubricator" type="checkbox"
                                value="13">เปลี่ยนน้ำมันเครื่อง</label>
                    </div>
                </div>
            </div>
        </div><br>
        ...
        <div class="hidden form-active-4">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control main-md btn-ga" name="timestart" id="timestart"
                            placeholder="06:00" value="06:00">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="garage">ช่วงเวลาปิด</label>
                        <input type="text" class="form-control main-md btn-ga" name="timeend" id="timeend"
                            placeholder="22:00" value="22:00">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-3">
                    <div class="form-check">
                        <label class="form-check-label" for="garage">
                            <input class="form-check-input" name="monday" id="monday" type="checkbox"
                                value="1">จันทร์</label>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-check">
                        <label class="form-check-label" for="garage">
                            <input class="form-check-input" name="tuesday" id="tuesday" type="checkbox"
                ...
                <div class="col-md-3">
                    <div class="form-check">
                        <label class="form-check-label" for="garage">
                            <input class="form-check-input" name="wednesday" id="wednesday" type="checkbox"
                                value="3">พุธ</label>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-check">
                        <label class="form-check-label" for="garage">
                            <input class="form-check-input" name="thursday" id="thursday" type="checkbox"
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-check">
                        <label class="form-check-label" for="garage">
                            <input class="form-check-input" name="friday" id="friday" type="checkbox"
                                value="5">ศุกร์</label>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-check">
                        <label class="form-check-label" for="garage">
                            <input class="form-check-input" name="saturday" id="saturday" type="checkbox"
                                value="6">เสาร์</label>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-check">
                        <label class="form-check-label" for="garage">
                            <input class="form-check-input" name="sunday" id="sunday" type="checkbox"
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control main-md btn-ga" name="hno_garage" id="hno_garage"
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control main-md btn-ga" name="alley_garage" id="alley_garage"
                            placeholder="ซอย">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control main-md btn-ga" name="road_garage" id="road_garage"
                            placeholder="ถนน">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control main-md btn-ga" name="village_garage" id="village_garage"
                            placeholder="หมู่ที่">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="form-control main-md btn-ga" type="number" name="postCode_garage"
                            id="postCode_garage" placeholder="รหัสไปรษณีย์">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
        ...
        <div class="hidden form-active-6">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-check">
                        <label class="form-check-label" for="garage">
                            <input class="form-check-input" name="roomfan" id="roomfan" value="2"
                ...
                <div class="col-md-3">
                    <div class="form-check">
                        <label class="form-check-label" for="garage">
                            <input class="form-check-input" name="roomAir" id="roomAir" value="3"
                ...
                <div class="col-md-3">
                    <div class="form-check">
                        <label class="form-check-label" for="garage">
                            <input class="form-check-input" name="snack" id="snack" value="4"
                                type="checkbox">ห้องน้ำ</label>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <input type="text" class="form-control main-md btn-ga" name="Otherfacilities"
                            id="Otherfacilities" placeholder="สิ่งอำนวยความสะดวกอื่นๆ">
                    </div>
                </div>
            </div>
        </div>
        ...
        <p class="form-show-7 btn-show"></p>
        <br>

        <div class="hidden form-active-8">
            ...
            <form id="login">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <button type="submit" class="btn btn-main-md width-100p active">บันทึก</button>
                        </div>
                    </div>
                </div>
            </form>
