                ...
                <div class="card">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body">
                                    <img id="myImg" src="<?php echo base_url('public/image/carprofile/front.jpg')?>" alt="หน้ารถ" class="w-75 border-0 rounded pointer mx-auto d-block">    
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body">
                                    <img id="myImg" src="<?php echo base_url('public/image/carprofile/back.jpg')?>" alt="หลังรถ" class="w-75 border-0 rounded pointer mx-auto d-block">
                                </div>
                                <div class="card-footer">
                                    <p>ด้านหลัง</p>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body">
                                    <img id="myImg" src="<?php echo base_url('public/image/carprofile/5d3c2cb0d56f6.png')?>" alt="เล่มทะเบียน" class="w-75 border-0 rounded pointer mx-auto d-block pb-4">
                                </div> 
                            </div>
                            <div class="card-footer">
                                <p>เล่มทะเบียน</p>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-7">
                                                        <div class="text-center">
                                                            <img src="https://www.tyremarket.com/images/products/EP150.jpg" width="100%">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-5">
