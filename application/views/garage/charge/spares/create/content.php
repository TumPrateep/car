<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">เพิ่มข้อมูลราคาเปลี่ยนอะไหล่</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">หน้าหลัก</a></li>
                <li class="breadcrumb-item active">เพิ่มข้อมูลราคาเปลี่ยนอะไหล่</li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-title">
                    <h4>เพิ่มข้อมูลราคาเปลี่ยนอะไหล่</h4>
