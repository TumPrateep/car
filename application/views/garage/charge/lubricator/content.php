<div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">ราคาเปลี่ยนน้ำมันเครื่อง</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">หน้าหลัก</a></li>
                        <li class="breadcrumb-item active">ราคาเปลี่ยนน้ำมันเครื่อง</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
                        ...
                        <div class="row justify-content-between">
                            ...
                            <div class="col-lg-3 offset-lg-5 mt-8">
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" id="price" placeholder="ค่าบริการ">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="changes-table" width="100%" cellspacing="0">
                                        <thead>
                                            ...
                                            <th><i class="fa fa-sort"></i>  ชนิดน้ำมันเครื่อง/เกียร์</th>
