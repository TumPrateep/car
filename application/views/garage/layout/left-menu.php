            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav"><hr>
                        ...
                        <li> <a class="has-arrow garage-white" href="#" aria-expanded="false"><i class="fa fa-address-book-o garage-white"></i><span class="hide-menu">จัดการข้อมูลอู่ </span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a class="garage-white" href="<?=base_url("garage/datagarage"); ?>"><i class="fa fa-cog garage-white icon-right"></i><span class="hide-menu">ข้อมูลอู่</span></a></li>
                                <li><a class="garage-white" href="<?=base_url("garage/datagarage"); ?>"><i class="fa fa-user garage-white icon-right"></i><span class="hide-menu">ข้อมูลเจ้าของอู่</span></a></li>
                            </ul>
                        </li>
                        ...
                        <li><a class="garage-white" href="<?=base_url("garage/commendandreview"); ?>"><i class="fa fa-comments garage-white"></i><span class="hide-menu">คะเเนนเเละรีวิว</span></a></li>
