	  	...
	  	<div class="row m-y-2">
	     	<div class="col-lg-12 push-lg-4">
		        <ul class="nav nav-tabs">
		           	...
		           	<li class="nav-item">
		              	<a href="" data-target="#users" data-toggle="tab" class="nav-link">ข้อมูลผู้ใช้งาน</a>
		           	</li>
		        </ul>
		        <div class="tab-content p-b-3">
							...
							<div class="row" >
								<div class="col-md-2">
									<div class="form-group" style="align-content: center;" >
										<button  type="submit" class="btn btn-info btn-block">ถัดไป</button>
									</div>
								</div>
							</div>
						</div>
		           	...
		           	<div class="tab-pane" id="users"><br>
		           		<div class="container">
		           			<div class="col-md-6">
					            <h4 class="underline orange">สมัครลงชื่อเข้าใช้งาน</h4>
								<form id="login">
								<div class="form-group">
