...
$(document).ready(function() {
    ...
    $.get(base_url + "apigarage/Review/searchScoreRating", {},
        function(data, textStatus, jqXHR) {
            ...
            scoreall = data;
            if (scoreall.all != 0) {
                averagescore = ((scoreall.five * 5) + (scoreall.four * 4) + (scoreall.three * 3) + (scoreall
                    .two * 2) + (scoreall.one * 1)) / scoreall.all;
            ...
            score += '<label>คะเเนนเเละรีวิว</label>' +
                ...
                '<div class="text-center"><span class="txt-rating">' + averagescorerating +
                '</span></div>' +
                ...
                '<div class="progress-bar bg-Orange" role="progressbar" style="width: ' + ((scoreall.five *
                    100) / scoreall.all) + '%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">' +
                scoreall.five + '</div>' +
                '</div>' +
                '</div>' +
                '</div>' +
                ...
                '<div class="col-md-10 progress-center" >' +
                '<div class="progress progress-hgt">' +
                '<div class="progress-bar bg-Orange" role="progressbar" style="width: ' + ((scoreall.four *
                    100) / scoreall.all) + '%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">' +
                scoreall.four + '</div>' +
                '</div>' +
                '</div>' +
                ...
                '<div class="col-md-10 progress-center" >' +
                '<div class="progress progress-hgt">' +
                '<div class="progress-bar bg-Orange" role="progressbar" style="width: ' + ((scoreall.three *
                    100) / scoreall.all) + '%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">' +
                scoreall.three + '</div>' +
                '</div>' +
                '</div>' +
                ...
                '<div class="col-md-10 progress-center" >' +
                '<div class="progress progress-hgt">' +
                '<div class="progress-bar bg-Orange" role="progressbar" style="width: ' + ((scoreall.two *
                    100) / scoreall.all) + '%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">' +
                scoreall.two + '</div>' +
                '</div>' +
                '</div>' +
                ...
                '<div class="col-md-10 progress-center" >' +
                '<div class="progress progress-hgt">' +
                '<div class="progress-bar bg-Orange" role="progressbar" style="width: ' + ((scoreall.one *
                    100) / scoreall.all) + '%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">' +
                scoreall.one + '</div>' +
                '</div>' +
                '</div>' +
    ...
    $.get(base_url + "apigarage/Review/searchScoreRatingbyMonth", {},
        function(data, textStatus, jqXHR) {
            ...
            if (scoreallbymonth.all != 0) {
                averagescorebymonth = ((scoreallbymonth.five * 5) + (scoreallbymonth.four * 4) + (
                    scoreallbymonth.three * 3) + (scoreallbymonth.two * 2) + (scoreallbymonth.one *
                    1)) / scoreallbymonth.all;
            ...
            scorebymonth += '<label>คะเเนนเเละรีวิว รายเดือน ' + scoreallbymonth.month + '</label>' +
                ' <div class="row">' +
                '<div class="col-md-4 "><br>' +
                '<div class="text-center"><span class="txt-rating">' + averagescoreratingbymonth +
                '</span></div>' +
                '<div class="text-center pad-star">' +
                rat_starbymonth +
                '</div>' +
                ...
                '<div class="col-md-10 progress-center" >' +
                '<div class="progress progress-hgt">' +
                '<div class="progress-bar bg-Orange" role="progressbar" style="width: ' + ((scoreallbymonth
                    .five * 100) / scoreallbymonth.all) +
                '%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">' + scoreallbymonth.five +
                '</div>' +
                '</div>' +
                '</div>' +
                '</div>' +
                ...
                '<div class="progress progress-hgt">' +
                '<div class="progress-bar bg-Orange" role="progressbar" style="width: ' + ((scoreallbymonth
                    .four * 100) / scoreallbymonth.all) +
                '%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">' + scoreallbymonth.four +
                '</div>' +
                '</div>' +
                '</div>' +
                '</div>' +
                ...
                '<div class="progress progress-hgt">' +
                '<div class="progress-bar bg-Orange" role="progressbar" style="width: ' + ((scoreallbymonth
                    .three * 100) / scoreallbymonth.all) +
                '%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">' + scoreallbymonth.three +
                '</div>' +
                '</div>' +
                '</div>' +
                '</div>' +
                ...
                '<div class="progress progress-hgt">' +
                '<div class="progress-bar bg-Orange" role="progressbar" style="width: ' + ((scoreallbymonth
                    .two * 100) / scoreallbymonth.all) +
                '%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">' + scoreallbymonth.two +
                '</div>' +
                '</div>' +
                '</div>' +
                '</div>' +
                ...
                '<div class="progress progress-hgt">' +
                '<div class="progress-bar bg-Orange" role="progressbar" style="width: ' + ((scoreallbymonth
                    .one * 100) / scoreallbymonth.all) +
                '%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">' + scoreallbymonth.one +
                '</div>' +
                '</div>' +
                '</div>' +
                '</div>' +
    ...
    $.post(base_url + "apigarage/Review/getdatarating", {},
        function(data, textStatus, jqXHR) {
            ...
            $.each(data.review, function(index, val) {
                ...
                if (val.status == 1) {
                    botcomment +=
                        '<button type="button" class="btn btn-success" onclick="commentrating(' +
                        val.ratingId +
                        ')" id="search"><i class="fa fa-comments"></i>  ตอบกลับ</i></button>';
                } else if (val.status == 2) {
                    botcomment +=
                        '<button type="button" class="btn btn-warning" onclick="editcommentratingId(' +
                        val.ratingId + "," + "'" + val.commentgarage + "'" +
                        ')" id="search"><i class="fa fa-comments"></i>  เเก้ไข</i></button>';
                }
                ...
                html += '<div class="card-comment">' +
                    ...
                    '<div class="text-center"><span class="txt-score">' + val.scorerating +
                    '</span></div><br>' +
                    ...
                    '<div class="row">' +
                    '<div class="col-md-12">' +
                    '<label> ' + val.titleName + " " + val.firstname + " " + val.lastname +
                    '</label>' +
                    '</div>' +
                    '<div class="col-md-12">' +
