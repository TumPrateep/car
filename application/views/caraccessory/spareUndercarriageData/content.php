...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">อะไหล่ช่วงล่าง</h3>  
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?=base_url("caraccessory/SpareundercarriesData"); ?>">อะไหล่</a></li>
    ...
    <div class="container-fluid">
        ...
        <div class="row p-30">
            <div class="col-lg-4 div-right">
                <a href="<?=base_url("caraccessory/SpareundercarriesData/createspareUndercarriageData") ?>">
