                        ...
                        $.each(data, function( index, value ) {
                            ...
                            html += '<div class="col-md-3 '+gray+'">'
                                ...
                                //  + '<h5 class="card-title">'+value.rim+' </h5>'
                                 ...
                                 + '<a href="'+base_url+"caraccessory/tiresize/updatetiresize/"+value.rimId+"/"+value.tire_sizeId+'"><button type="button" class="btn btn-warning btn-sm  m-b-10 m-l-5 card-button"><i class="ti-user"></i> แก้ไข</button></a> '
