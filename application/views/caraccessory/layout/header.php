                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?=$name ?> <img src="<?=base_url("/public/themes/caraccessory/images/users/5.jpg") ?>" alt="user" class="profile-pic" /></a>
