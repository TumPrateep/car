...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?=base_url("caraccessory/SpareBrand/index/$spares_undercarriageId"); ?>">รายการรุ่นรถ</a></li>
        ...
        <div class="row bg-white p-30 search-header">
            <div class="col-md-6">
                <a href="<?=base_url("caraccessory/SpareBrand/createSpareBrand/$spares_undercarriageId") ?>">
                    <button type="button" class="btn btn-info m-b-10 m-l-5" >เพิ่มรายการยี่ห้ออะไหล่</button>
                </a>     
            </div>
