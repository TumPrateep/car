...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">ยี่ห้อน้ำมันเครื่อง</h3>  
        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row p-30">
            <div class="col-lg-4 div-right">
                <a href="<?=base_url("caraccessory/brandlubricator/createBrandLubricator") ?>">
            ...
            <div class="col-lg-4">
                <div class="input-group input-group-flat">
                    ...
                    <input type="text" class="form-control input-default" id="lubricatorbrandName-search" placeholder="ค้นหา...">
