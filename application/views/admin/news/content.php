    ...
    <div class="table-responsive">
      <table class="table table-bordered" id="news-table" width="100%" cellspacing="0">
        <thead>
          ...
          <th><i class="fa fa-picture-o"></i> รูปหัวข้อข่าว</th>
          <th><i class="fa fa-rebel"></i>  เรื่อง</th>
          <th><i class="fa fa-rebel"></i>  หมวดหมู่</th>
          <th><i class="fa fa-rebel"></i>  วันที่สิ้นสุด</th>
