            ...
            "columnDefs": [
                ...
                },
                {
                    ...
                    "render": function ( data, type, full, meta ) {
                        return '<a href="'+base_url+"admin/payment/managepartsshopshow/"+data.userId+'"><button type="button" class="btn btn-info"><i class="fa fa-search-plus" aria-hidden="true">จ่ายเงิน</i></button></a> ' 
                    }
                },
                {
                    "targets": 0,
