<div class="container-fluid">
    ...
    <ol class="breadcrumb">
        <li class="breadcrumb-item">
            <a href="<?=base_url("admin/payment/garage")?>">การจ่ายเงิน</a>
        </li>
        <li class="breadcrumb-item">
            <a href="<?=base_url("admin/payment/garage_detail/" . $garageId)?>">รายการสั่งซื้อ</a>
        </li>
        <li class="breadcrumb-item">
            <a href="<?=base_url("admin/payment/garage_bill/" . $garageId)?>">รายการบิลจ่ายเงิน</a>
        </li>
                    ...
                    <table class="table table-bordered">
                        <thead class="text-center">
                            <tr>
                                ...
                                <th scope="col" width="10%">ค่าจัดส่ง</th>
