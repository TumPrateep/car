<script>
    var table = $('#changes-table').DataTable({
        "language": {
            ...
            "serverSide": true,
            "ajax":{
                "url": base_url+"api/tirelimit/searchGarageGruop",
                "dataType": "json",
                "type": "POST"
            },
            "order": [[ 1, "asc" ]],
            ...
            "columnDefs": [
                {
                    ...
                    "data": null,
                    "render": function ( data, type, full, meta ) {
                        return '<a href="'+base_url+"admin/tirelimit/tiresizecharge/"+data.groupId+'"><button type="button" class="btn btn-info"><i class="fa fa-search-plus" aria-hidden="true"></i></button></a> ';
