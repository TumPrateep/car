            ...
            "columnDefs": [
                {
                    ...
                    "data": null,
                    "render": function ( data, type, full, meta ) {
                        return '<a href="'+base_url+"admin/car/model/modelofcar/"+data.modelId+"/"+data.modelofcarId+'"><button type="button" class="btn btn-info"><i class="fa fa-search-plus" aria-hidden="true"></i></button></a> '
