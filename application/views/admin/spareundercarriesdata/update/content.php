<div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="<?=base_url("admin/spareundercarriesdata/updatespareundercarriesdata") ?>">ข้อมูลอะไหล่ช่วงล่างตามรถยนต์</a>
        </li>
          ...
          <div class="row">
            <div class="col-md-10">
              <div class="card text-white bg-success">
                  ...
                  <form id="update-spareundercarriesdata" >
                  <input type="hidden" id="spares_undercarriageDataId" name="spares_undercarriageDataId" value="<?=$sparesundercarriageDataId ?>">
