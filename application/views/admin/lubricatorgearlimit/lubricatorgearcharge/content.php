    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="<?=base_url("admin/lubricatorgearlimit/garagegroup") ?>">ราคาเปลี่ยนถ่ายน้ำมันเกียร์</a>
        </li>
    ...
    <div class="card-tools one">
      <form id="form-search">
        ...
        <a class="btn btn-primary create" href="<?=base_url("admin/lubricatorgearlimit/createLubricatorGearCharge/".$groupId) ?>">
