                ...
                <div class="col-md-10">
                    <div class="card text-white bg-success">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-tint"></i>  แก้ไขข้อมูลเบอร์น้ำมันเกียร์</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->

                        <form id="update-lubricatornumber">
                        <input type="hidden" name="lubricator_numberId" id="lubricator_numberId" value="<?=$lubricatorNumberId?>">
