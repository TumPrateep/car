    ...
    <div class="card-tools one">
      <form id="form-search">
        ...
        <a class="btn btn-primary create" href="<?=base_url("admin/partstable/create") ?>">
          <i class="fa fa-plus">  สร้าง</i>
        </a>

        <div class="input-group float-right">
          <input id="table-search" class="form-control float-right" placeholder="รายการสินค้า">
     ...
     <div class="table-responsive">
      <table class="table table-bordered" id="changes-table" width="100%" cellspacing="0">
        <thead>
          ...
          <th><i class="fa fa-toggle-left"></i>  ตารางเช็คระยะ</th>
          <th>สถานะ</th>
          <th></th>
        </thead>	
      </table>
